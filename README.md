# stReans
<!-- badges: start -->
[![R-CMD-check](https://github.com/Luki308/stReans/actions/workflows/R-CMD-check.yaml/badge.svg)](https://github.com/Luki308/stReans/actions/workflows/R-CMD-check.yaml)
<!-- badges: end -->
...
[testthat](https://testthat.r-lib.org/) and run automatically
via GitHub Actions on Linux, macOS, and Windows:
